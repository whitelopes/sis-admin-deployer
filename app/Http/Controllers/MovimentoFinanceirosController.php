...
use App\Http\Requests\MovimentosFinanceirosRequest;
use App\Models\MovimentosFinanceiro;
use Illuminate\Http\Request;

class MovimentoFinanceirosController extends Controller
{
    /**
     ...
     */
    public function store(MovimentosFinanceirosRequest $request)
    {
