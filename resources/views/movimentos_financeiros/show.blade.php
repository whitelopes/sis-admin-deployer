...
@section('title')
    <h1>Detalhes Movimentos Financeiros</h1>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{ url('/movimentos_financeiros/' . $movimentos_financeiro->id) }}">Detalhes Movimentos Financeiros</a>
    </li>
@endsection
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Tipo </th><td><span class="badge badge-{{ $movimentos_financeiro->tipo === 'entrada' ? 'success' : 'dancger' }}">{{ ucfirst($movimentos_financeiro->tipo) }}</span></td>
                                    </tr>
                                    <tr>
                                        <th>Razão Social </th><td>{{ $movimentos_financeiro->empresa->nome }} ({{ $movimentos_financeiro->empresa->razao_social }})</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th> Data </th><td> {{ data_iso_para_br($movimentos_financeiro->created_at) }} </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
